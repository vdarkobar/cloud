...
echo
echo -e "${GREEN} This script will install and configure${NC} Nginx Proxy Manager"
echo
echo
...
echo -e " - Time Zone and NPM Port Number (web interface)"
...
##################################
# Create db_root_pwd.secret file #
##################################

# Define the path to the directory and the file
file_path="$WORK_DIR/.secrets/db_root_pwd.secret"
...
# Create or overwrite the docker-compose.yml file, using sudo for permissions
echo -e "${GREEN} Creating db_root_pwd.secret file...:${NC} $file_path"
...
echo
echo -e "${GREEN} db_root_pwd.secret file created successfully:${NC} $file_path"
echo


################################
# Create mysql_pwd.secret file #
################################

# Define the path to the directory and the file
file_path="$WORK_DIR/.secrets/mysql_pwd.secret"
...
# Create or overwrite the docker-compose.yml file, using sudo for permissions
echo -e "${GREEN} Creating mysql_pwd.secret file...:${NC} $file_path"
...
echo
echo -e "${GREEN} mysql_pwd.secret file created successfully:${NC} $file_path"
echo
