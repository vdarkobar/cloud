...
virt-customize -a "$TEMP_DIR/$IMAGE_NAME" \
    --install qemu-guest-agent,sudo,wget,isc-dhcp-client,net-tools,nano,less,locales,apt-utils,cron,logrotate,openssl,gnupg,strace,file,bash-completion,dmidecode,ethtool,rsyslog,openssh-server \
